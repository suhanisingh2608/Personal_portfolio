...
export default function Hero() {
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-10 left-20 w-96 h-96 bg-gradient-to-br from-blue-200 to-indigo-200 rounded-full blur-3xl opacity-30 animate-pulse-soft"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-xl">
              I turn ideas into code, win hackathons, and contribute to
              open-source. Learning something new every day and building cool
              stuff along the way. 💻
            </p>
