...
export default function Skills() {
  const technicalSkills = [
    ...
    { category: 'Frontend', skills: ['React', 'Tailwind CSS', 'Responsive Design'] },
  ...
  return (
    <section id="skills" className="py-24 bg-gradient-to-b from-gray-50 via-pastel-purple/30 to-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-100/80 rounded-full mb-6">
            <Zap size={16} className="text-purple-600" />
            <span className="text-sm font-semibold text-purple-700">Skills</span>
          </div>
          <h2 className="text-5xl md:text-6xl font-black text-gray-900 mb-6">What I Can Do</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            A mix of technical chops and soft skills that help me build great things and work well with others.
          </p>
        </div>
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {technicalSkills.map((skillGroup) => (
              ...
              >
                <h4 className="text-lg font-bold text-indigo-600 mb-4 group-hover:text-indigo-700">{skillGroup.category}</h4>
                <ul className="space-y-2">
                  {skillGroup.skills.map((skill) => (
                    <li key={skill} className="flex items-center gap-2 text-gray-700 font-medium text-sm">
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 border-2 border-gray-200">
          <h3 className="text-3xl font-bold text-gray-900 mb-10">Proficiency Levels</h3>
          <div className="space-y-8">
            {[
              { skill: 'Python & Problem Solving', level: 80, color: 'from-yellow-400 to-orange-400' },
              { skill: 'JavaScript & Frontend Development', level: 75, color: 'from-blue-400 to-cyan-400' },
              { skill: 'Data Structures & Algorithms', level: 75, color: 'from-purple-400 to-pink-400' },
              { skill: 'Web Development & APIs', level: 70, color: 'from-green-400 to-emerald-400' },
            ].map((item) => (
              <div key={item.skill}>
