        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {softSkills.map((skill) => (
              <div
                key={skill}
                className="bg-gray-800/50 rounded-xl p-4 text-center border border-gray-700/50 hover:border-blue-400/50 hover:bg-gray-700/50 transition-all duration-300 font-semibold text-sm"
              >
